...
import "vulkan" Vulkan.Core10.Pass qualified as Rp
import "vulkan" Vulkan.Core10.Pass hiding (RenderPass, createRenderPass, destroyRenderPass,
                                  withRenderPass, createFramebuffer,
                                  destroyFramebuffer, withFramebuffer)
import "vulkan" Vulkan.Zero        qualified as Vk

import Vulkan.Swapchain qualified as Sw
import Vulkan.Builder   (Builder, execBuilder, get, modify, put)
